<template>
  <div style="width: 100%; height: 100%; overflow: auto">
    <table style="width: 100%">
      <tr>
        <td>Name:</td>
        <td><InputText v-model="component.name" @change="emitRecompile()" style="width: 95%"/></td>
      </tr>
      <tr v-if="component.options!==undefined">
        <td>Optionen:</td>
        <td><InputText @change="emitUpdate()" v-model="component.options" style="width: 95%"/></td>
      </tr>
      <tr v-if="component.label!==undefined">
        <td>Text:</td>
        <td><InputText @change="emitUpdate()" v-model="component.label" style="width: 95%"/></td>
      </tr>
      ...
      <tr v-if="type && type.labels && type.labels.value!==undefined">
        <td>Wert:</td>
        <td><InputText @change="emitUpdate()" v-model="component.value" style="width: 95%"/></td>
      </tr>
      <tr v-if="component.placeholder!==undefined">
        <td>Platzhalter:</td>
        <td><InputText @change="emitUpdate()" v-model="component.placeholder" style="width: 95%"/></td>
      </tr>
      <template v-if="component.template!==undefined">
        <tr>
          <td rowSpan="2">Template:</td>
          <td><InputText @change="emitUpdate()" v-model="component.template" style="width: 95%" /></td>
        </tr>
