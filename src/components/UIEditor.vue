...
<script>
  ...
  export default{
    ...
    data: function(){
      return {
        componentList: [{type: "JPanel", components: [], template: "1", onAction: false}, {type: "JLabel", value: "JLabel", valueType: "html", onAction: false},{type: "JButton", value: "JButton", valueType: "html", actionCommand: "", onAction: true},{type: "JTextField", inputType: "text", value: "", placeholder: "JTextField", valueType: "inline-text", onAction: false},{type: "JTextArea", value: "", placeholder: "JTextArea", valueType: "text", onAction: false}, {type: "JCheckBox", value: true, label: "JCheckBox", valueType: "Boolean", onAction: false}, {type: "JComboBox", value: "Ja", options: '["Ja","Nein","Vielleicht"]',valueType: "text", onAction: false}, {type: "DataTable", onAction: false}, {type: "JImage", value: "https://thomaskl.uber.space/Webapps/Assets/graphics/overworld/house-front.png", valueType: "text", onAction: false}, {type: "Canvas", components: [], internalWidth: 100, internalHeight: 100, onAction: false}, {type: "For", controlComponent: {min: 1, max: 10, variable: "i"}}, {type: "If", controlComponent: {condition: "true"}}, {type: "ElseIf", controlComponent: {condition: "true"}}, {type: "Else", controlComponent: {}}],
